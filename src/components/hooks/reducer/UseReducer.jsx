...
const UseReducer = () => {
  ...
  return (
    <div className='p-15'>
      <div className="grid md:flex gap-5 items-center font-semibold">
        <p className=' text-5xl  text-white font-bold'>A todo app with <span className="text-yellow-500">useReducer</span> to manage <span className="text-red-600">States.</span></p>
      ...
      <div className="mt-10 text-white font-semibold">
        <p onClick={showSnippet} className="hover:cursor-pointer mb-10"><span>{showReducerSnippet ? "Hide" : "Show"} </span>useReducer Snippet</p>
